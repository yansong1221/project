...
int test(char *URL)
{
  ...
  if(UNEX(res)) {
    err("UPKEEP_INTERVAL_MS", res, __LINE__); goto test_cleanup; }
  ...
  if(UNEX(res)) {
    err("CURLU", res, __LINE__); goto test_cleanup; }
  ...
  if(UNEX(res)) {
    err("ALTSVC_CTRL", res, __LINE__); goto test_cleanup; }
  ...
  if(UNEX(res)) {
    err("SASL_AUTHZID", res, __LINE__); goto test_cleanup; }
  ...
  if(UNEX(res)) {
    geterr("TOTAL_TIME_T", res, __LINE__); goto test_cleanup; }
  res = curl_easy_getinfo(curl, CURLINFO_NAMELOOKUP_TIME_T, &oval);
  if(UNEX(res)) {
    geterr("NAMELOOKUP_TIME_T", res, __LINE__); goto test_cleanup; }
  res = curl_easy_getinfo(curl, CURLINFO_CONNECT_TIME_T, &oval);
  if(UNEX(res)) {
    geterr("CONNECT_TIME_T", res, __LINE__); goto test_cleanup; }
  res = curl_easy_getinfo(curl, CURLINFO_PRETRANSFER_TIME_T, &oval);
  if(UNEX(res)) {
    geterr("PRETRANSFER_TIME_T", res, __LINE__); goto test_cleanup; }
  res = curl_easy_getinfo(curl, CURLINFO_STARTTRANSFER_TIME_T, &oval);
  if(UNEX(res)) {
    geterr("STARTTRANSFER_TIME_T", res, __LINE__); goto test_cleanup; }
  res = curl_easy_getinfo(curl, CURLINFO_REDIRECT_TIME_T, &oval);
  if(UNEX(res)) {
    geterr("REDIRECT_TIME_T", res, __LINE__); goto test_cleanup; }
  res = curl_easy_getinfo(curl, CURLINFO_APPCONNECT_TIME_T, &oval);
  if(UNEX(res)) {
    geterr("APPCONNECT_TIME_T", res, __LINE__); goto test_cleanup; }
  res = curl_easy_getinfo(curl, CURLINFO_RETRY_AFTER, &oval);
  if(UNEX(res)) {
    geterr("RETRY_AFTER", res, __LINE__); goto test_cleanup; }
